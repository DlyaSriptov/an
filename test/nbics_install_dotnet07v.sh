...
echo 'export PATH="$PATH:/opt/mssql-tools/bin"' >> /home/ok/.bash_profile
echo 'export PATH="$PATH:/opt/mssql-tools/bin"' >> /home/ok/.bashrc
source /home/ok/.bashrc
...
systemctl status mssql-server nginx kestrel-"$nbicsNameDomain"-service.service
